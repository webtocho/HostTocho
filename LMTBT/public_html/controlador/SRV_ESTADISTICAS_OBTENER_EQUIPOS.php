<?php
    ...
    //Si se cumple la condicion se devuelve los datos en codigo html para un select, donde el value es el id del roster y el texto de la opcion el nombre del equipo
