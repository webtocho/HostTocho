...
/**
 * Este metodo muestra la lista de las convocatorias inactivas, es decir, que ya se han cerrado y se espera la ejecucion del torneo (encuentros de equipos(roles de juego))
 */
